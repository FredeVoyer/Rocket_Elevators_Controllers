...
class Column {
    ...
    findElevator(requestedFloor, direction) {
        ...
        var toto= Math.abs(this.elevatorList[0].floor - requestedFloor);
        var toto2= Math.abs(this.elevatorList[1].floor - requestedFloor);
        console.log('init i ' + toto);
        for (var i = 0; i < this.elevatorAmount; i++) {
            elevatorDistanceList.push(Math.abs(this.elevatorList[0].floor - requestedFloor));
           // elevatorDistanceList[i] = Math.abs(this.elevatorList[0].floor - requestedFloor);
            /*toto = elevatorList[i].floor
            toto2=  Math.abs(toto - requestedFloor);
            console.log('calcul i ' + toto);
            //elevatorDistanceList.push(elevatorList[i].distance);
            elevatorDistanceList[i]=toto2;
            //elevatorDistanceList[i]=this.elevatorList[i].distance;*/
        }
        console.log('toto i ' + toto);
        console.log('toto2 i ' + toto2);
        console.log('this.elevatorList[i].distance: ' + this.elevatorList[0].floor + 'et' +  this.elevatorList[1].floor);
        console.log('this.elevatorList[i].distance: ' + this.elevatorList[0].distance + 'et' +  this.elevatorList[1].distance);
        console.log('elevatorDistanceList: ' + elevatorDistanceList[0] + 'et' + + elevatorDistanceList[1]);
    ...
    requestElevator(requestedFloor, direction) {
        ...
        if (this.elevatorList[idElevatorSelected-1].floor < requestedFloor) {
            ...
            console.log('elevator' + elevator.id + ' direction is: ' + this.elevatorList[idElevatorSelected-1].direction);
...
function scenario1() {
    ...
    var indexElevatorSelected = columnA.requestElevator(3, "up");
    //Elevator.requestFloor(elevatorSelected, 7);  
    columnA.elevatorList[indexElevatorSelected].requestFloor(elevatorSelected, 7);  
